  ...
  return (
    <div className="row">
      <div className="container mb-3">
        ...
        <div className="mb-3">
          <select onChange={handleSelectChange} value={selectedSalesperson} required name="salespeople" id="salespeople" className="form-select">
      ...
      <div className="container mb-3">
        <table className="table table-striped">
          ...
          <tbody>
            {sales.filter(purchase => purchase.salesperson.id === selectedSalesperson).map(purchase => (
